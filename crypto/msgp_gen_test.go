...
func TestMarshalUnmarshalFalconCTSignature(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := FalconCTSignature{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
...
func TestRandomizedEncodingFalconCTSignature(t *testing.T) {
	protocol.RunEncodingTest(t, &FalconCTSignature{})
}

func BenchmarkMarshalMsgFalconCTSignature(b *testing.B) {
	v := FalconCTSignature{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgFalconCTSignature(b *testing.B) {
	v := FalconCTSignature{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalFalconCTSignature(b *testing.B) {
	v := FalconCTSignature{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestMarshalUnmarshalFalconS1Coefficients(t *testing.T) {
	partitiontest.PartitionTest(t)
	v := FalconS1Coefficients{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
		t.Fatal(err)
...
func TestRandomizedEncodingFalconS1Coefficients(t *testing.T) {
	protocol.RunEncodingTest(t, &FalconS1Coefficients{})
}

func BenchmarkMarshalMsgFalconS1Coefficients(b *testing.B) {
	v := FalconS1Coefficients{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgFalconS1Coefficients(b *testing.B) {
	v := FalconS1Coefficients{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalFalconS1Coefficients(b *testing.B) {
	v := FalconS1Coefficients{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
